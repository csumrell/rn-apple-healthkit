...
RCT_EXPORT_METHOD(getSources:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self body_getSources:input callback:callback];
}
...
RCT_EXPORT_METHOD(updateWeight:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
